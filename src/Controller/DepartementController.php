...
class DepartementController extends AbstractController
{
    ...
    #[Route('/admin', name: 'app_departement_indexadmin', methods: ['GET'])]
    public function indexadmin(DepartementRepository $departementRepository): Response
    {
        return $this->render('departement/indexback.html.twig', [
            'departements' => $departementRepository->findAll(),
        ]);
    }
