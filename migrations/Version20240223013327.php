 ...
 */
final class Version20240223013327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495587F4FB17 FOREIGN KEY (doctor_id) REFERENCES docteur (id)');
